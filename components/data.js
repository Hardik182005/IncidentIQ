// AUTO-GENERATED from data.jsx by tools/build-dashboard.mjs — do not edit.
(function () {
// =============================================
...
const CHAOS_SCENARIOS = [{
  ...
  id: 'db-deadlock',
  label: 'Database Deadlock Aborts',
  service: 'postgres-primary',
  severity: 'CRITICAL'
}];
const AI_STAGES = [{
  name: 'Groq',
  role: 'Initial triage & log parsing',
  color: '#F59E0B',
  processingTime: '1.2s'
}, {
  name: 'Gemini',
  role: 'Pattern matching & correlation',
  color: '#3B82F6',
  processingTime: '2.1s'
}, {
  name: 'OpenAI',
  role: 'Root cause synthesis',
  color: '#8B5CF6',
  processingTime: '1.8s'
}];
...
const TOPOLOGY_EDGES = [['gateway', 'auth'], ['gateway', 'payments'], ['gateway', 'user'], ['auth', 'postgres'], ['payments', 'postgres'], ['user', 'cache'], ['user', 'notif']];
