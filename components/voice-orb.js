// AUTO-GENERATED from voice-orb.jsx by tools/build-dashboard.mjs — do not edit.
(function () {
// =============================================
...
const API_BASE = typeof location !== 'undefined' && location.protocol.startsWith('http') ? '' : 'http://127.0.0.1:8000';

// Fallback replies used only when the /api/chat call fails (offline demo mode).
const RESPONSES = ['Root cause confirmed: PostgreSQL connection pool exhaustion on payments-api. The idle_timeout was set to 300s in the last deploy. I recommend draining idle connections and scaling the pool to 200 immediately.', 'The auth-service JWT latency spike correlates with the cert renewal 11 minutes ago. The JWKS endpoint cache appears stale — force a cache refresh on all auth-service pods.', 'Three services in degraded state right now: payments-api critical, auth-service high, notification-worker medium. Cascade risk is elevated — recommend activating runbook INC-2847-RB.'];
...
function VoiceOrb({
  ...
  function startBars() {
    clearInterval(barLoop.current);
    barLoop.current = setInterval(() => setBars(Array.from({
      length: 5
    }, () => 15 + Math.random() * 70)), 90);
  }
  ...
  function handleChipClick(chipText) {
    ...
    askBackend(chipText).catch(() => RESPONSES[Math.floor(Math.random() * RESPONSES.length)]).then(answer => {
      setState('speaking');
      startBars();
      setResponse('');
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, (response || transcript) && /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, "\"", transcript, "\""), response && /*#__PURE__*/React.createElement("p", {
    style: {
      color: '#eeeef5',
      fontSize: '12px',
      lineHeight: '1.65',
  ...
  }, response, state === 'speaking' && /*#__PURE__*/React.createElement("span", {
    style: {
  ...
  }))), open && showChips && state === 'idle' && /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: '6px',
  ...
  }, CHIPS.map((chip, i) => /*#__PURE__*/React.createElement("button", {
    key: i,
    ...
    onMouseLeave: e => {
      e.target.style.background = 'rgba(255,255,255,0.048)';
      e.target.style.color = '#f1f5f9';
      e.target.style.borderColor = 'rgba(255,255,255,0.18)';
    }
  }, chip))), open && state === 'idle' && /*#__PURE__*/React.createElement("form", {
    onSubmit: e => {
      e.preventDefault();
      if (inputText.trim()) {
  ...
  }, state === 'idle' && /*#__PURE__*/React.createElement("div", {
    style: {
      width: '26px',
      height: '26px',
      borderRadius: '50%',
  ...
  }), (state === 'listening' || state === 'speaking') && /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'center',
      gap: '3px',
  ...
  }))), state === 'processing' && /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'relative',
      width: '34px',
      height: '34px'
    ...
    speaking: 'SPEAKING...'
  }[state]), state === 'idle' && /*#__PURE__*/React.createElement("div", {
    style: {
      color: '#9aa0ad',
      fontSize: '9px',
      fontFamily: "'JetBrains Mono', monospace",
