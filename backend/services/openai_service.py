        ...
        messages=[
            {
                ...
                "content": (
                    ...
                    "2. Detect the language of the user's message and reply ONLY in that SAME "
                    "language and script. If they write in English, answer in English; if they "
                    "write in Hindi, Marathi, Tamil, Telugu, Bengali, Gujarati, Punjabi, Kannada, "
                    "or Malayalam — in either the native script OR a romanized/Latin form — you "
                    "MUST answer fully in that same language.\n"
                    "3. Marathi (मराठी) is fully supported: whenever the user writes Marathi, "
                    "always reply in Marathi. Do NOT fall back to Hindi or English for a Marathi "
                    "message.\n"
                    "4. If the user explicitly instructs a language (e.g. 'reply in Marathi', "
